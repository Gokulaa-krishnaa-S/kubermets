        ...
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground mb-4">
              Monitor the full spectrum of Kubernetes metrics across eight key
              categories. Each section provides detailed insights into your
              cluster's health, performance, and resource utilization.
            </p>
